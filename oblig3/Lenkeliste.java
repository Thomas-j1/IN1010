...
class Lenkeliste<T> implements Liste<T>{
    ...
    public void leggTil(int pos, T x)throws UgyldigListeIndeks{ //legger nytt element i lenkeliste, resterende elementer blir lagt bak i koen
    ...
    public void sett(int pos, T x)throws UgyldigListeIndeks{ //overskriver element paa angitt posisjon
        if (erTom() || pos>=stoerrelse() || pos<0) {throw new UgyldigListeIndeks(pos);}
        Node tmp = start;
        Node forrige = start;
    ...
    public T fjern(int pos) throws UgyldigListeIndeks{ //fjerner element paa angitt index posisjon, og returnerer denne
        if (erTom() || pos>=stoerrelse() || pos<0) {throw new UgyldigListeIndeks(pos);}
        Node tmp = start;
        Node forrige = start;
