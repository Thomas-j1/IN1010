public class TestLenkeliste {
    ...
    static void testTom() {
        ...
        sjekk(0, liste.stoerrelse(), "stoerrelse() i tom liste"); //test 1
    }
    ...
    static void testEttElement() {
        ...
        liste.leggTil(0);
        System.out.println(liste.toString());
        sjekk(1, liste.stoerrelse(), "stoerrelse() i liste med ett element"); //test 2
        Integer hentetElement = liste.hent(0);
        System.out.println(liste.toString());
        sjekk(0, hentetElement, "hent(0) i liste med ett element"); //test 3
        // hent(0) skal ikke fjerne elementet, la oss sjekke at fjerning fungerer
        System.out.println(liste.toString());
        Integer fjernetElement = liste.fjern(0);
        sjekk(0, fjernetElement, "fjern(0) i liste med ett element"); //test 4
        System.out.println(liste.toString());
        sjekk(0, liste.stoerrelse(), "stoerrelse() etter at eneste element er fjernet"); //test 5
    }
    ...
    static void testLeggTilOgFjerningAvFlereElementer() {
        ...
        System.out.println(liste.toString());
        sjekk(4, liste.stoerrelse(), "stoerrelse() i liste med 4 elementer"); //test 6
        System.out.println(liste.toString());
        sjekk("Element 0", liste.hent(0), "hent(0) i liste med 4 elementer"); //test 7
        System.out.println(liste.toString());
        sjekk("Element 3", liste.hent(3), "hent(3) i liste med 4 elementer"); //test 8
        System.out.println(liste.toString());
        sjekk("Element 0", liste.fjern(), "fjern() i liste med 4 elementer"); //test 9
        System.out.println(liste.toString());
        sjekk("Element X", liste.fjern(), "fjern() (for andre gang) i liste med 3 elementer"); //test 10
        System.out.println(liste.toString());
        sjekk(2, liste.stoerrelse(), "stoerrelse() etter fjerning av 2 av 4 elementer"); //test 11
    }
    ...
    static void testLeggTilPaaIndeks() {
        ...
        System.out.println(liste.toString());
        sjekk("Element X", liste.hent(0), "hent(0) etter leggTil(0, \"Element X\")"); //test12
        ...
        System.out.println(liste.toString());
        sjekk("Foran X", liste.hent(0), "hent(0) etter leggTil(0, \"Foran X\")"); //test 13
        sjekk("Foran A", liste.hent(2), "hent(2) etter flere leggTil med og uten indeks"); //test 14
        sjekk("Element B", liste.hent(4), "hent(4) etter flere leggTil med og uten indeks"); //test 15
        liste.leggTil(5, "Bakerst");
        sjekk("Bakerst", liste.hent(5), "hent(5) etter leggTil(5, \"Bakerst\")"); //test 16
        sjekk(6, liste.stoerrelse(), "stoerrelse() etter leggTil med og uten indeks"); //test 17
    }
    ...
    static void testFjernOgSettMedIndeks() {
        ...
        System.out.println(liste.toString());
        sjekk("nyVerdi 0", liste.hent(0), "hent(0) etter sett(0, \"nyVerdi 0\")"); //test 18
        sjekk("nyVerdi 2", liste.hent(2), "hent(2) etter sett(2, \"nyVerdi 2\")"); //test 19
        sjekk("Element 3", liste.fjern(3), "fjern(3)"); //test 20
        sjekk("Element 4", liste.fjern(3), "fjern(3) for andre gang"); //test 21
        liste.leggTil("NyttElement");
        sjekk("NyttElement", liste.hent(3), "hent(3) skal hente nytt element lagt til etter at andre elementer har blitt  fjernet"); //test 22
        sjekk(4, liste.stoerrelse(), "stoerrelse() etter flere kall paa fjern() og leggTil()"); //test 23
    }
