...
class SortertLenkeliste<T extends Comparable<T>> extends Lenkeliste<T> {
    ...
    @Override
    public void leggTil(int pos, T x) throws UnsupportedOperationException { // kaster unntak hvis man bruker den arvete
                                                                             // metoden
        throw new UnsupportedOperationException();
    }

    @Override
    public void sett(int pos, T x) throws UnsupportedOperationException { // kaster unntak hvis man bruker den arvete
                                                                          // metoden
        throw new UnsupportedOperationException();
    }
}
